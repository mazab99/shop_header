class ExampleData {
  ...
  static PageData data = PageData(
    ...
    bannerText:
    "Use code HELLOPANDA to get 50% off for the first order starting from ${4.5}",
    backgroundUrl:
  ...
  static Category category1 = Category(
    title: "Favorites",
    subtitle: "Sell faster than others now",
    isHotSale: true,
    foods: List.generate(
      5,
          (index) {
  ...
  static Category category2 = Category(
    title: "Buy 1 Get 1",
    subtitle: "Waiting for at least 30 minutes",
    isHotSale: false,
    foods: List.generate(
      3,
          (index) {
        return Food(
          name: "Sokolum Dok Orkob",
          price: "1.33",
          comparePrice: "\$1.90",
          imageUrl: images[index % images.length],
